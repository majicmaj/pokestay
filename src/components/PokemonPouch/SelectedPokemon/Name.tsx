  ...
  return (
    <>
      <div className="relative max-w-96 w-full flex py-8 mb-[-32px] max-h-96 aspect-square flex-col justify-between items-center">
        <div className="relative z-10 text-accent-foreground bg-card px-2 rounded-full">
        ...
        <div className="relative flex items-center flex-col">
          <div className="font-semibold text-3xl mt-[-16px] flex items-center bg-card px-2 rounded-full">
        ...
        {pokemon.isShiny && (
          <div className="absolute top-[-24px] right-0 z-10">
