...
const FilterControls: React.FC<FilterControlsProps> = ({
  ...
  return (
    <div className="w-full p-4 flex flex-col gap-4 bg-gray-100 rounded-b-xl">
      <input
        value={searchTerm}
        autoFocus
        onChange={(e) => setSearchTerm(e.target.value)}
        className="px-3 py-2 bg-white w-full rounded-full border border-gray-300"
        ...
        {sortOptions.map((option) => (
          <button
            ...
            className={`px-2 py-1 rounded-full ${
              sortBy === option ? "bg-lime-300 text-lime-800" : "bg-gray-200"
            }`}
